...
if not exist "C:\Python27\Lib\site-packages\zope.interface-3.6.4-py2.7-win32.egg\zope\__init__.py" "C:\Program Files%arch%\GnuWin32\bin\wget.exe" https://github.com/downloads/jackjack-jj/pywallet-win-files/zope.interface-3.7.0.win32-py2.7.exe
